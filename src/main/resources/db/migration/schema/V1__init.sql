...
(
    ...
    c_surname           VARCHAR(25) NOT NULL,
    c_patronymic        VARCHAR(40),
    c_status_of_students VARCHAR(30) NOT NULL CHECK (c_status_of_students IN ('ACTIVE', 'NON_ACTIVE')),
...
(
    ...
    c_role VARCHAR(30) NOT NULL CHECK ( t_users.c_role IN ('ROLE_ADMIN', 'ROLE_TEACHER', 'ROLE_STUDENT')),
    c_profile_id BIGINT
)